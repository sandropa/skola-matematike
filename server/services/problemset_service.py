...
class ProblemsetService:
    ...
    def create_problemset_and_problems(
        ...
        """
        logger.info(f"Service: Creating problemset '{problemset_data.lecture_name}' and {len(problemset_data.problems_latex)} problems in DB.")

        # Create the Problemset ORM object
        db_problemset = Problemset(
            title=problemset_data.lecture_name,
            type="predavanje",
